...
export interface ApiAccountUserAccountUser extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Role: Schema.Attribute.Enumeration<
      ['Super Admin', 'Fnac Manager', 'Seller']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<'oneToOne', 'api::transaction.transaction'>;
  };
}
...
export interface ApiItemItem extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    seller: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
...
export interface ApiOrderTransactionOrderTransaction
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
  };
}
